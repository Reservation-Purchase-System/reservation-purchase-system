...
class ReservationProductServiceTest {
  ...
  class create {
    ...
    void success() {
      //given
      ReservationProductCreateRequestDto request = mockProductCreateRequest();
      ...
      //when
      Long productId = reservationProductService.create(product.getId(), request.name(), request.content(),
  ...
  class update {
    ...
    void success() {
      //given
      Long principalId = 1L;
      ReservationProductUpdateRequestDto request = mockProductUpdateRequest();
      ReservationProduct product = mockProduct(request.reservedAt());
      ...
      //when
      reservationProductService.update(principalId, product.getId(), request.name(), request.content(),
          request.price(), request.stock(), request.reservedAt());
  ...
  class getProductStockById {
    ...
    void success() {
      ...
      //when
      ReservationProductStockDto response = reservationProductService.getProductStockById(productId);
  ...
  class getProductInfoById {
    ...
    void success() {
      ...
      //when
      ReservationProductDto response = reservationProductService.getProductInfoById(productId);
  ...
  private ReservationProductCreateRequestDto mockProductCreateRequest() {
    return ReservationProductCreateRequestDto.builder()
        .name("테스트 상품1")
        .content("테스트 상품1 내용")
        .price(10000L)
        .stock(100)
  ...
  private ReservationProductUpdateRequestDto mockProductUpdateRequest() {
    return ReservationProductUpdateRequestDto.builder()
